...
<span class="keyword">signature</span>
  ...
  <span class="keyword">sorts</span>
    ...
    <span class="cons_SortAlias"><a href="#BracketLiteral_152_55" id="BracketLiteral_21_5" title="Referenced at line 152, 155"><span class="token sort_Id">BracketLiteral</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#AtomLiteral_146_19" id="AtomLiteral_22_5" title="Referenced at line 146"><span class="token sort_Id">AtomLiteral</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#AllChars_148_18" id="AllChars_23_5" title="Referenced at line 148"><span class="token sort_Id">AllChars</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    ...
    <span class="cons_SortAlias"><a href="#QuotablePatternSymbolLex_255_29" id="QuotablePatternSymbolLex_53_5" title="Referenced at line 255"><span class="token sort_Id">QuotablePatternSymbolLex</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#Integer_115_24" id="Integer_54_5" title="Referenced at line 115, 116, 117, 121, 122, 123, 127, 128, 129"><span class="token sort_Id">Integer</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#OctalValue_178_17" id="OctalValue_55_5" title="Referenced at line 178"><span class="token sort_Id">OctalValue</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#TwoHexValue_179_18" id="TwoHexValue_56_5" title="Referenced at line 179"><span class="token sort_Id">TwoHexValue</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#FourHexValue_180_18" id="FourHexValue_57_5" title="Referenced at line 180"><span class="token sort_Id">FourHexValue</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#BackReferenceLex_200_21" id="BackReferenceLex_58_5" title="Referenced at line 200"><span class="token sort_Id">BackReferenceLex</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    <span class="cons_SortAlias"><a href="#ControlValue_193_24" id="ControlValue_59_5" title="Referenced at line 193"><span class="token sort_Id">ControlValue</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
    ...
    <span class="cons_SortAlias"><a href="#RegexID_257_15" id="RegexID_61_5" title="Referenced at line 257"><span class="token sort_Id">RegexID</span></a> <span class="operator">=</span> <span class="cons_StringSort">string</span></span>
